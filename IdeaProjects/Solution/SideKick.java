...
/** TODO 9 Solution to: Make this class a child class of the Robot class by using
 *          "extends Robot" after the "class SideKick" above.
 *          is implemented by using "extends Robot" after the "public class SideKick".
 **/
public class SideKick extends Robot {
   ...
   // method to set choice
    public void setChoice() {
        ...
        /** TODO 10 Solution: Replace the direct assignment of the property "modeOfOperation"
    ...
    public void takeAction() {
        /** TODO 11 Solution: Replace the direct use of the property "modeOfOperation"
         *           in the switch to use the getter method.
